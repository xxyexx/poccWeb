...
<div class="options">
  ...
  <div class="col-sm-4 col-md-4">
    <div class="thumbnail">
      <a href="teacher/homepage.html"><img class="img-responsive" src="res/images/thumbnail_Pic6.png" alt="主页"></a>
      <div class="caption">
        <h3><a href="teacher/homepage.html">个人主页</a></h3>
        </div>
    </div>
  </div>
  <div class="col-sm-4 col-md-4">
...
<div class="row">
   <div class="col-sm-4 col-md-4">
    <div class="thumbnail">
      <a href="teacher/homework.html"><img class="img-responsive" src="res/images/thumbnail_Pic9.png" alt="作业"></a>
      <div class="caption">
        <h3><a href="teacher/homework.html">作业管理</a></h3>
        </div>
    </div>
  </div>
     <div class="col-sm-4 col-md-4">
    <div class="thumbnail">
      <a href="teacher/classes.html"><img class="img-responsive" src="res/images/thumbnail_Pic10.png" alt="资源"></a>
      <div class="caption">
        <h3><a href="teacher/classes.html">教学管理</a></h3>
        </div>
    </div>
  </div>
     <div class="col-sm-4 col-md-4">
    <div class="thumbnail">
      <a href="teacher/resources.html"><img class="img-responsive" src="res/images/thumbnail_Pic3.png" alt="设置"></a>
      <div class="caption">
        <h3><a href="teacher/resources.html">学习资源</a></h3>
        </div>
    </div>
  </div>
</div> 
