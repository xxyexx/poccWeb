			...
			<div class="media">
			  <div class="media-left">
			    <a href="user/settings.html?select=1">
			      <img style="width: 80px;height:80px; border: 1px solid #DDD;"  class="media-object" src="user/showIcon.html" alt="点击更改头像">
			    </a>
			  </div>
	...
	<div class="module2">
		<div class="part1 col-md-6">
			<div class="panel panel-default">
			  ...
			  <hr/>
			  <a class="viewmore" href="teacher/homework.html">查看更多</a>
			</div>
		</div>
