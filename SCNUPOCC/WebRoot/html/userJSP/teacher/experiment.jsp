...
<div class="main">
	...
	<div class="leftpart col-md-3">
		<div class="sidebar">
		  ...
		  <ul id="homeworkTabs" class="nav nav-tabs" role="tablist">
		    ...
		    <li role="presentation" class=""><a href="#ExpManage" aria-controls="ExpManage" role="tab" data-toggle="tab">添加课程</a></li>
		  </ul>
		</div>
	</div>
	<div class="rightpart col-md-9">
	  ...
	  <div class="tab-content">
	    ...
	    <div role="tabpanel" class="tab-pane" id="ExpManage">
	    	<div class="boxtitle"><h4><b>添加实验课程</b></h4></div>
	    	<form action="teacher/addExperiment.html" method="post" class="form-horizontal">
		    	<div class="form-group col-md-12"><br>
		    	<label for="exp" class="col-sm-3 control-label">请输入实验名(标题)</label>
		    	<div class="col-sm-6">
		    		<input name="experiment.title" type="text" required="required" class="form-control" id="title" placeholder="标题">
		   	    </div>
		  	    </div><br>	
		    	<div class="form-group col-md-12">
		    	<label for="exp" class="col-sm-3 control-label">请输入实验内容</label>
		    	<div class="col-sm-6">
		    		<textarea name="expDesc" rows="5"  class="form-control" placeholder="请输入实验内容（限300字以内）" maxlength="300"></textarea>
		   	    </div>
		  	    </div><br>
		  	   	<div class="form-group col-md-12">
