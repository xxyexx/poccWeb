...
<div class="options">
  ...
  <div class="col-sm-4 col-md-4">
    <div class="thumbnail">
      <a href="manager/managerpageview.html"><img class="img-responsive" src="res/images/thumbnail_Pic11.png" alt="管理"></a>
      <div class="caption">
        <h3><a href="manager/managerpageview.html">院校管理</a></h3>
        </div>
    </div>
  </div>
  <div class="col-sm-4 col-md-4">
