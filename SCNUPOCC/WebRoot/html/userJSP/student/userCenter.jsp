	  	 ...
	  	 <div class="boxtitle"><h4><b>个人信息</b></h4></div>
	    	...
	    	<form action="student/changeInfo.html" method="post" class="form-horizontal">
		    	...
		    	<div class="col-sm-6">
		  	   	...
		  	   	<div class="form-group col-md-12">
		    	<label for="className" class="col-sm-2 control-label">实验课程班级</label>
		    	<div class="col-sm-6">
		     	 	<input type="text" class="form-control" id="className" placeholder="班级名称" readonly="readonly" value="${request.className}">
		   	    </div>
		  	    </div><hr>
		  	   	<div class="form-group col-md-12">
